...
test("comparison contract is harness-independent but changes when a controlled factor changes", () => {
  ...
  try {
    ...
    assert.equal(first.contract.version, "single-action-comparison-v10-allied-layered-defense");
    ...
    assert.equal(sae.contract.version, "single-action-comparison-v10-allied-layered-defense");
    ...
    assert.equal(taskSae.contract.version, "single-action-comparison-v10-allied-layered-defense");
    ...
    assert.equal(taskSae.contract.task_progress_version, "combined-goal-task-progress-v5");
    ...
    assert.equal(taskSae.contract.frontier_breakthrough_protocol, "dynamic-frontier-breakthrough-v1");
