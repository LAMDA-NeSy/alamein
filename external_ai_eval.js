...
const DEFAULT_CONTEXT = path.join(ROOT, "last_external_ai_context.json");
const DEFAULT_TRANSCRIPT = path.join(ROOT, "last_external_ai_transcript.json");
const DEFAULT_OUT = path.join(ROOT, "last_external_ai_eval.json");
